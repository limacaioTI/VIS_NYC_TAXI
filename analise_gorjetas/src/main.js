...
window.onload = async () => {
    ...
    try {
        ...
        // Criar gráficos
        criarGraficoQuantidade("chart-count", data2018, data2023);
        criarGraficoMedia("chart-avg", data2018, data2023);
        criarGraficoComparacao("chart-comparison", data2018, data2023);
